...
//or die(mysql_error());
//$db = mysql_select_db("DaveC42_Portal", $connection) or
//die(mysql_error());
$connect=mysql_connect("mysql509.ixwebhosting.com", "DaveC42_user3", "uUUuzU8d35cc");
mysql_select_db("DaveC42_Portal",$connect);
$username;
$password;
...
if(mysql_num_rows($result)>0){
	...
	echo "<td><a href='connect.php?operation=edit&id=".$row['id']."&username=".$row['username']."&password=".$row['password']."'>edit</a></td>";
	echo "<td><a href='connect.php?operation=delete&id=".$row['id']."'>delete</a></td>";	
	echo "</tr>";
	}
	echo "</table>";
}
